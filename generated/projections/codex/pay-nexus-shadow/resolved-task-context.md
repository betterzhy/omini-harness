...
- Resolution: `resolution:99bc04697015fab6d5848e3b`
...
## Conflict Signals
- `skill:agent-design:architecture-review` vs `current-formal-status.md#current-execution-authority` → `PROJECT_TRUTH_WINS`
